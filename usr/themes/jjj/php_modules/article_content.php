  ...
  <div class="article-content-card">
    <div class="article-content-card-head" itemprop="author" itemscope itemtype="http://schema.org/Person">
      ...
      <div class="article-content-author">
        ...
        <a class="article-content-edit-btn" href="<?php $this->options->adminUrl();?>write-<?php if ($this->is('post')): ?>post<?php else: ?>page<?php endif;?>.php?cid=<?php echo $this->cid; ?>" target="_self">Edit</a>
        <?php endif;?>
      </div>
    </div>
