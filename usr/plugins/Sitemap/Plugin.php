...
define('__TYPECHO_PLUGIN_SITEMAP_VERSION__', '2.0.5');
...
class Sitemap_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function activate()
    {
        foreach (self::$routes as $route) {
            ...
            Helper::addRoute("sitemap_{$route['name']}_nosuffix_route", "/{$route['url']}", 'Sitemap_Action', $route['name']);
        }
        // 更新提示
    ...
    public static function deactivate()
    {
        foreach (self::$routes as $route) {
            ...
            Helper::removeRoute("sitemap_{$route['name']}_nosuffix_route");
        }
    }
